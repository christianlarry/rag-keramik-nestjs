...
export type OutboxWhereInput = {
  ...
  errorMessage?: Prisma.StringNullableFilter<"Outbox"> | string | null
}
...
export type OutboxScalarWhereWithAggregatesInput = {
  ...
  errorMessage?: Prisma.StringNullableWithAggregatesFilter<"Outbox"> | string | null
}
...
export type OutboxOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "aggregateId" | "aggregateType" | "eventType" | "payload" | "createdAt" | "processedAt" | "errorMessage", ExtArgs["result"]["outbox"]>
...
export interface OutboxFieldRefs {
  ...
  readonly errorMessage: Prisma.FieldRef<"Outbox", 'String'>
}
